...
module.exports = {
  ...
  slashData: new SlashCommandBuilder()
    .setName("fuck")
    .setDescription("Fuck a user (NSFW).")
    .addUserOption(o => o.setName("user").setDescription("The user to fuck.").setRequired(true))
    .toJSON(),
  ...
  async execute(client, ctx) {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        .setColor(0xED4245)
        .setDescription(`👉 **${author.username}** is fucking **${target.username}**!`)
        .setImage(url);
